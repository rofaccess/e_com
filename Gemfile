...
# Use Json Web Token (JWT) for token based authentication. https://github.com/jwt/ruby-jwt/tree/v1.5.6
gem 'jwt', '1.5.6'
...
# Generates swagger-ui json files for Rails APIs with a simple DSL. https://github.com/richhollis/swagger-docs
